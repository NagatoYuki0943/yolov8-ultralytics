...
```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True conf=0.25 iou=0.6 model=weights/yolov8n.pt data=ultralytics/cfg/datasets/coco128.yaml device=0
```

## torchscript

```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True conf=0.25 iou=0.6 model=weights/yolov8n.torchscript data=ultralytics/cfg/datasets/coco128.yaml device=0
```
...
```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True conf=0.25 iou=0.6 model=weights/yolov8n.onnx data=ultralytics/cfg/datasets/coco128.yaml device=0
```
...
```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True conf=0.25 iou=0.6 model=weights/yolov8n_openvnio_model data=ultralytics/cfg/datasets/coco128.yaml device=cpu
```

## tensorrt

```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True conf=0.25 iou=0.6 model=weights/yolov8n.onnx data=ultralytics/cfg/datasets/coco128.yaml device=0 half=True
```
