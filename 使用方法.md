...
yolo task=detect mode=predict imgsz=640 save=True conf=0.25 iou=0.6 data=ultralytics/cfg/datasets/coco128.yaml model=weights/yolov8n.fp16.onnx half=True source=ultralytics/assets/bus.jpg device=0           # fp16模型需要 half=True
...
yolo task=detect mode=predict imgsz=640 save=True conf=0.25 iou=0.6 data=ultralytics/cfg/datasets/coco128.yaml model=weights/yolov8n.cpu.dynamic.onnx source=ultralytics/assets/bus.jpg device=0              # 使用cpu导出的dynamic模型可以用gpu推理
...
```sh
yolo task=detect mode=predict imgsz=640 save=True conf=0.25 iou=0.6 data=ultralytics/cfg/datasets/coco128.yaml model=weights/yolov8n.engine half=True source=ultralytics/assets/bus.jpg device=0                          # fp32模型也能用 --half 推理
...
yolo task=detect mode=predict imgsz=640 save=True conf=0.25 iou=0.6 data=ultralytics/cfg/datasets/coco128.yaml model=weights/yolov8n.fp32.dynamic.engine half=True source=ultralytics/assets/bus.jpg device=0             # fp32模型也能用 --half 推理
