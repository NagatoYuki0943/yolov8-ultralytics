...
```sh
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8s.engine data=ultralytics/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=0

yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8s.engine data=ultralytics/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=0
```
