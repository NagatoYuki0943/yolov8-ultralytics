...
| ------------------------------------------------------------ | ------------- | ------------ | ---------------------- | --------------------------- | ---------- | --------- |
| [yolov8s](https://github.com/ultralytics/assets/releases/download/v0.0.0/yolov8s.pt) | 640           | 37.3         | 80.4                   | 0.99                        | 3.2        | 8.7       |
...
```sh
yolo task=detect mode=val imgsz=640 save_json=True save_hybrid=True save_txt=True save_conf=True model=weights/yolov8s.pt data=ultralytics/datasets/coco128.yaml device=0
```

## torchscript

```sh
yolo task=detect mode=val imgsz=640 save_json=True save_hybrid=True save_txt=True save_conf=True model=weights/yolov8s.torchscript data=ultralytics/datasets/coco128.yaml device=0
```
...
```sh
yolo task=detect mode=val imgsz=640 save_json=True save_hybrid=True save_txt=True save_conf=True model=weights/yolov8s.onnx data=ultralytics/datasets/coco128.yaml device=0
```
...
```sh
yolo task=detect mode=val imgsz=640 save_json=True save_hybrid=True save_txt=True save_conf=True model=weights/yolov8s_openvnio_model data=ultralytics/datasets/coco128.yaml device=cpu
```

## tensorrt

```sh
yolo task=detect mode=val imgsz=640 save_json=True save_hybrid=True save_txt=True save_conf=True model=weights/yolov8s.onnx data=ultralytics/datasets/coco128.yaml device=0 half=True
```
