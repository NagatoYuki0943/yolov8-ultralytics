...
yolo task=detect mode=export imgsz=640 model=weights/yolov8n.pt format=onnx simplify=True device=cpu dynamic=True 			 # dynamic only compatible with cpu
...
yolo task=detect mode=export imgsz=640 model=weights/yolov8n.pt format=openvino simplify=True device=cpu half=True # v5导出时，openvino支持half,但是要使用cpu导出onnx的half会报错,所以要使用 --device 0, openvino导出和设备无关,不受影响,主要是导出onnx的问题 v8没问题
```
...
```sh
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.pt data=ultralytics/cfg/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=0

yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.pt data=ultralytics/cfg/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=0
```

## torchscript

```sh
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.torchscript data=ultralytics/cfg/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=0

yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.torchscript data=ultralytics/cfg/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=0
```
...
```sh
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.onnx data=ultralytics/cfg/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=0
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.onnx data=ultralytics/cfg/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=0

yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.fp16.onnx half=True data=ultralytics/cfg/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=0			# fp16模型需要 half=True
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.fp16.onnx half=True data=ultralytics/cfg/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=0

yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.cpu.dynamic.onnx data=ultralytics/cfg/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=0				# 使用cpu导出的dynamic模型可以用gpu推理
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.cpu.dynamic.onnx data=ultralytics/cfg/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=0
```
...
```sh
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n_openvino_model data=ultralytics/cfg/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=cpu

yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n_openvino_model data=ultralytics/cfg/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=cpu
```

## tensorrt

```sh
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.engine half=True data=ultralytics/cfg/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=0						# fp32模型也能用 --half 推理
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.engine half=True data=ultralytics/cfg/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=0

yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.fp16.engine half=True data=ultralytics/cfg/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=0
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.fp16.engine half=True data=ultralytics/cfg/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=0

yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.fp32.dynamic.engine half=True data=ultralytics/cfg/datasets/coco128.yaml source=ultralytics/assets/bus.jpg device=0			 # fp32模型也能用 --half 推理
yolo task=detect mode=predict imgsz=640 save=True model=weights/yolov8n.fp32.dynamic.engine half=True data=ultralytics/cfg/datasets/coco128.yaml source=../datasets/coco128/images/train2017 device=0
```
...
```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True model=weights/yolov8n.pt data=ultralytics/cfg/datasets/coco128.yaml device=0
```

## torchscript

```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True model=weights/yolov8n.torchscript data=ultralytics/cfg/datasets/coco128.yaml device=0
```
...
```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True model=weights/yolov8n.onnx data=ultralytics/cfg/datasets/coco128.yaml device=0
```
...
```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True model=weights/yolov8n_openvnio_model data=ultralytics/cfg/datasets/coco128.yaml device=cpu
```

## tensorrt

```sh
yolo task=detect mode=val imgsz=640 save_json=True save_txt=True save_conf=True model=weights/yolov8n.onnx data=ultralytics/cfg/datasets/coco128.yaml device=0 half=True
```
